    ...
    <div class="container mx-auto min-h-screen flex flex-col md:flex-row py-0 relative bg-gray-50">
        ...
        <aside
            ...
            <div class="block w-full pt-4 mb-6">
                <h4 class="text-2xl font-bold text-center">Flip Image</h4>
            ...
            <div class="w-full flex flex-col items-center gap-4 mb-8">
                <div class="grid grid-cols-2 gap-4 w-full">
                    <button id="vertically_btn"
                        class="group h-24 bg-white/95 backdrop-blur-sm text-gray-800 flex flex-col items-center justify-center rounded-xl shadow-lg hover:shadow-xl hover:bg-white transition-all duration-200 border border-white/20">
                        <i
                            class="fa-solid fa-up-down text-blue-500 text-3xl mb-2 group-hover:scale-110 transition-transform duration-200"></i>
                        <span class="text-xs font-bold">Vertical</span>
                    </button>
                    <button id="horizontally_btn"
                        class="group h-24 bg-white/95 backdrop-blur-sm text-gray-800 flex flex-col items-center justify-center rounded-xl shadow-lg hover:shadow-xl hover:bg-white transition-all duration-200 border border-white/20">
                        <i
                            class="fa-solid fa-left-right text-blue-500 text-3xl mb-2 group-hover:scale-110 transition-transform duration-200"></i>
                        <span class="text-xs font-bold">Horizontal</span>
                    </button>
                </div>
            </div>
        ...
        <div id="mobileToolbox"
            ...
            <div class="px-6 pb-8 overflow-y-auto max-h-[75vh]">
                <div class="text-center mb-6">
                    <h4 class="text-2xl font-bold text-white">Flip Image Tools</h4>
                    <div class="w-16 h-1 bg-white/30 mx-auto mt-2 rounded-full"></div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <button id="vertically_btn_mobile"
                        class="group h-20 bg-white/95 backdrop-blur-sm text-gray-800 flex flex-col items-center justify-center rounded-xl shadow-lg active:scale-95 transition-all duration-200">
                        <i
                            class="fa-solid fa-up-down text-blue-500 text-2xl mb-1 group-active:scale-110 transition-transform duration-200"></i>
                        <span class="text-xs font-bold">Vertical</span>
                    </button>
                    <button id="horizontally_btn_mobile"
                        class="group h-20 bg-white/95 backdrop-blur-sm text-gray-800 flex flex-col items-center justify-center rounded-xl shadow-lg active:scale-95 transition-all duration-200">
                        <i
                            class="fa-solid fa-left-right text-blue-500 text-2xl mb-1 group-active:scale-110 transition-transform duration-200"></i>
                        <span class="text-xs font-bold">Horizontal</span>
                    </button>
                </div>
