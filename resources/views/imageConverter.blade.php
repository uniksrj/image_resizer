    ...
    <div class="container mx-auto min-h-screen flex flex-col md:flex-row py-0 relative bg-gray-50">
        ...
        <aside
            ...
            <div class="block w-full pt-4 mb-6">
                <h4 class="text-2xl font-bold text-center">Convert Image</h4>
            ...
            <div class="w-full flex flex-col items-center gap-2 mt-20 mb-10">
                ...
                <div class="space-y-4">
                    ...
                    <button id="process_data"
                        class="w-full h-16 bg-gradient-to-r from-sky-400 to-sky-500 rounded-xl text-white text-lg font-bold hover:from-sky-500 hover:to-sky-600 transition-all duration-200 shadow-lg hover:shadow-xl">
        ...
        <div id="mobileToolbox"
            ...
            <div class="px-6 pb-8 overflow-y-auto max-h-[75vh]">
                <div class="text-center mb-6">
                    <h4 class="text-2xl font-bold text-white">Convert Image Tools</h4>
                    <div class="w-16 h-1 bg-white/30 mx-auto mt-2 rounded-full"></div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6 relative">
                    <div class="col-span-2 sm:col-span-1 flex flex-col ">
                        <label for="format" class="block text-sm font-medium text-gray-700 mb-2">Convert To</label>
                        <div class="w-full">
                            <button id="dropdownButton_mobile"
                                class="w-full flex justify-between items-center border border-gray-300 rounded-lg px-4 py-2 bg-white shadow-sm hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <span id="selectedValue_mobile" class="block text-gray-700 text-sm truncate">Select Format</span>
                                <svg class="w-4 h-4 ml-2 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            <ul id="dropdownList_mobile"
                                class="absolute left-0 w-full border border-gray-300 rounded-lg bg-white shadow-lg hidden mt-1 z-50 max-h-60 overflow-y-auto text-sm">
                                <li data-value="jpeg"
                                    class="dropdown-item text-black px-4 py-2 hover:bg-blue-200 cursor-pointer">JPEG</li>
                                <li data-value="png"
                                    class="dropdown-item text-black px-4 py-2 hover:bg-blue-200 cursor-pointer">PNG</li>
                                <li data-value="webp"
                                    class="dropdown-item text-black px-4 py-2 hover:bg-blue-200 cursor-pointer">WebP</li>
                                <li data-value="gif"
                                    class="dropdown-item text-black px-4 py-2 hover:bg-blue-200 cursor-pointer">GIF</li>
                                <li data-value="bmp"
                                    class="dropdown-item text-black px-4 py-2 hover:bg-blue-200 cursor-pointer">BMP</li>
                            </ul>
                            <input type="hidden" name="format" id="format_mobile" value="">
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="col-span-2 sm:col-span-1 flex flex-col">
                        <label for="quality_mobile" class="block text-sm font-medium text-gray-700 mb-2">
                            Compression Quality (Only for JPEG/PNG)
                        </label>
                        <input type="number" name="quality" id="quality_mobile"
                            class="form-input h-10 p-2 text-black w-full border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm"
                            min="10" max="100" value="80" required>
                    </div>
                </div>
                ...
                <!-- Action Buttons -->
                <div class="space-y-4">
                    <button id="resetButtonMobile"
                        class="w-full h-12 bg-white/20 backdrop-blur-sm rounded-xl text-white font-semibold active:scale-95 transition-all duration-200 border border-white/20">
                        <i class="fa-solid fa-rotate-left mr-2"></i>Reset
                    </button>
                    <button id="process_data_mobile"
                        class="w-full h-16 bg-gradient-to-r from-sky-400 to-sky-500 rounded-xl text-white text-lg font-bold active:scale-95 transition-all duration-200 shadow-lg">
                        <i class="fa-solid fa-magic-wand-sparkles mr-2"></i>Process Image
                    </button>
                </div>
            </div>
        ...
        <main class="w-full md:w-3/4 bg-white shadow-xl flex flex-col min-h-screen">
            ...
            <div
                ...
                <div class="text-xs text-gray-400">Ready to flip your image</div>
            </div>
